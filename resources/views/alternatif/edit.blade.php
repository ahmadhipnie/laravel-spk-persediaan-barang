...
<div class="w-full px-6 py-6 mx-auto">
    <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
        <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
            <h6>Form Edit Alternatif</h6>
            <p class="text-sm text-slate-500">Perbarui data alternatif</p>
        </div>
            ...
            <form action="{{ route('alternatif.update', $alternatif->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="kode_alternatif" required value="{{ old('kode_alternatif', $alternatif->kode_alternatif) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <select name="barang_id" id="barang_id" required onchange="fillBarangData()"
                            ...
                            <option value="{{ $brg->id }}"
                                    ...
                                    {{ old('barang_id', $alternatif->barang_id) == $brg->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_barang" id="nama_barang" readonly value="{{ $alternatif->nama_barang }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="stok_tersedia" id="stok_tersedia" readonly value="{{ $alternatif->stok_tersedia }}"
                            class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-200 bg-gray-100 bg-clip-padding px-4 py-3 font-normal text-gray-700 transition-all">
                    </div>
                    ...
                    <div class="mb-4 md:col-span-2">
                        ...
                        <textarea name="keterangan" rows="3"
                            class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-4 py-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                            placeholder="Keterangan (opsional)">{{ old('keterangan', $alternatif->keterangan) }}</textarea>
                        @error('keterangan')
                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
