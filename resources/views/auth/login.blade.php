                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex-auto p-6">
                                    ...
                                    @if (session('success'))
                                        <div
                                            class="relative p-4 mb-4 text-white bg-gradient-to-tl from-green-600 to-lime-400 rounded-lg">
                                    ...
                                    @if (session('error'))
                                        <div
                                            class="relative p-4 mb-4 text-white bg-gradient-to-tl from-red-600 to-rose-400 rounded-lg">
