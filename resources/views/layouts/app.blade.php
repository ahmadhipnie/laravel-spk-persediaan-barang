                        ...
                        <g transform="translate(1716.000000, 291.000000)">
                            <g transform="translate(603.000000, 0.000000)">
                                <path class="fill-slate-800 opacity-60"
                                    d="M21,0 L0,10 L0,14 L42,14 L42,10 L21,0 Z M14,20 L14,42 L28,42 L28,20 L14,20 Z M0,16 L0,42 L12,42 L12,18 L0,16 Z M30,18 L30,42 L42,42 L42,16 L30,18 Z">
                                </path>
                            </g>
                        </g>
                    </g>
...
<!-- Data Alternatif tetap ada di bawahnya -->
                ...
                <li class="mt-0.5 w-full">
                    <a href="{{ route('alternatif.index') }}" class="{{ request()->routeIs('alternatif.*') ? 'is-active py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors' : 'py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors text-slate-700' }}">
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Data Alternatif</span>
                    </a>
                </li>
                                    ...
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                        <g transform="translate(1716.000000, 291.000000)">
                                            <g transform="translate(153.000000, 2.000000)">
                                                <path class="fill-slate-800 opacity-60"
                                                    d="M10,10 L32,10 C33.1045695,10 34,10.8954305 34,12 L34,12 C34,13.1045695 33.1045695,14 32,14 L10,14 C8.8954305,14 8,13.1045695 8,12 L8,12 C8,10.8954305 8.8954305,10 10,10 Z M10,20 L32,20 C33.1045695,20 34,20.8954305 34,22 L34,22 C34,23.1045695 33.1045695,24 32,24 L10,24 C8.8954305,24 8,23.1045695 8,22 L8,22 C8,20.8954305 8.8954305,20 10,20 Z M10,30 L32,30 C33.1045695,30 34,30.8954305 34,32 L34,32 C34,33.1045695 33.1045695,34 32,34 L10,34 C8.8954305,34 8,33.1045695 8,32 L8,32 C8,30.8954305 8.8954305,30 10,30 Z">
                                                </path>
                                                <circle class="fill-slate-800" cx="2" cy="12" r="2"></circle>
                                                <circle class="fill-slate-800" cx="2" cy="22" r="2"></circle>
                                                <circle class="fill-slate-800" cx="2" cy="32" r="2"></circle>
                                            </g>
                                        </g>
                                    </g>
                                </g>
                ...
                <li class="mt-0.5 w-full">
                    <a href="{{ route('penilaian.index') }}" class="{{ request()->routeIs('penilaian.*') ? 'is-active py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors' : 'py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors text-slate-700' }}">
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Input Penilaian</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a href="{{ route('perhitungan.index') }}" class="{{ request()->routeIs('perhitungan.*') ? 'is-active py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors' : 'py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors text-slate-700' }}">
                                    ...
                                    <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                        <g transform="translate(1716.000000, 291.000000)">
                                            <g transform="translate(304.000000, 151.000000)">
                                                <path class="fill-slate-800 opacity-60"
                                                    d="M34,0 L6,0 C2.6862915,0 0,2.6862915 0,6 L0,38 C0,41.3137085 2.6862915,44 6,44 L34,44 C37.3137085,44 40,41.3137085 40,38 L40,6 C40,2.6862915 37.3137085,0 34,0 Z M10,10 L30,10 L30,14 L10,14 L10,10 Z M10,20 L14,20 L14,24 L10,24 L10,20 Z M10,28 L14,28 L14,32 L10,32 L10,28 Z M18,20 L22,20 L22,24 L18,24 L18,20 Z M18,28 L22,28 L22,32 L18,32 L18,28 Z M26,20 L30,20 L30,32 L26,32 L26,20 Z">
                                                </path>
                                            </g>
                                        </g>
                                    </g>
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Perhitungan SAW</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a href="{{ route('hasil.index') }}" class="{{ request()->routeIs('hasil.*') ? 'is-active py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors' : 'py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors text-slate-700' }}">
                                ...
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                        <g transform="translate(1716.000000, 291.000000)">
                                            <g transform="translate(153.000000, 2.000000)">
                                                <path class="fill-slate-800 opacity-60"
                                                    d="M10,0 L10,6 L8,6 C5.790861,6 4,7.790861 4,10 C4,12.209139 5.790861,14 8,14 L10,14 L10,16 C10,20.418278 13.581722,24 18,24 L18,28 L14,28 C12.8954305,28 12,28.8954305 12,30 L12,32 L30,32 L30,30 C30,28.8954305 29.1045695,28 28,28 L24,28 L24,24 C28.418278,24 32,20.418278 32,16 L32,14 L34,14 C36.209139,14 38,12.209139 38,10 C38,7.790861 36.209139,6 34,6 L32,6 L32,0 L10,0 Z">
                                                </path>
                                            </g>
                                        </g>
                                    </g>
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Hasil & Ranking</span>
                    </a>
                </li>
                ...
                @auth
                    ...
                    <li class="mt-0.5 w-full">
                        <form method="POST" action="{{ route('logout') }}" class="m-0">
                            @csrf
                            <button type="submit"
                                class="w-full py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors bg-transparent border-0 cursor-pointer text-left text-slate-700 hover:text-slate-900">
                                <div
                                    class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                                    <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1"
                                        xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF"
                                                ...
                                                <g transform="translate(1716.000000, 291.000000)">
                                                    <g transform="translate(304.000000, 151.000000)">
                                                        <path class="fill-slate-800 opacity-60"
                                                            d="M10.5,0 L29.5,0 L29.5,6 L26.5,6 L26.5,3 L13.5,3 L13.5,37 L26.5,37 L26.5,34 L29.5,34 L29.5,40 L10.5,40 Z">
                                                        </path>
                                                        <path class="fill-slate-800"
                                                            d="M21,20 L37,20 L33,16 L34.5,14.5 L40,20 L34.5,25.5 L33,24 L37,20 L21,20 Z">
                                                        </path>
                                                    </g>
                                                </g>
                                            </g>
