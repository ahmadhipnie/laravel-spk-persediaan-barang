...
<html>
  <head>
    ...
    <link
      ...
      sizes="76x76"
      href="{{ asset('theme/img/apple-icon.png') }}" />
    ...
    <!-- Main Styling -->
    <link
      href="{{ asset('theme/css/soft-ui-dashboard-tailwind.css?v=1.0.5') }}"
      rel="stylesheet" />
    ...
    <aside
      ...
      <div class="h-19.5">
        ...
        <a
          ...
          target="_blank">
          <img
            src="{{ asset('theme/img/logo-ct.png') }}"
      ...
      <div class="mx-4">
        ...
        <div
          ...
          <div
            ...
            style="
              background-image: url('{{ asset('theme/img/curved-images/white-curved.jpeg') }}');
            "></div>
                  ...
                  <li class="relative mb-2">
                    <a
                      ...
                      <div class="flex py-1">
                        <div class="my-auto">
                          <img
                            src="{{ asset('theme/img/team-2.jpg') }}"
                  ...
                  <li class="relative mb-2">
                    <a
                      ...
                      <div class="flex py-1">
                        <div class="my-auto">
                          <img
                            src="{{ asset('theme/img/small-logos/logo-spotify.svg') }}"
                ...
                <div class="flex flex-wrap -mx-3">
                  ...
                  <div
                    ...
                    <div
                      ...
                      <img
                        src="{{ asset('theme/img/shapes/waves-white.svg') }}"
                      ...
                      <div
                        ...
                        <img
                          ...
                          src="{{ asset('theme/img/illustrations/rocket-white.png') }}"
                          alt="rocket" />
                      </div>
                    </div>
                  </div>
          ...
          <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
            <div
              ...
              <div
                ...
                style="background-image: url('{{ asset('theme/img/ivancik.jpg') }}')">
                <span
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('theme/img/small-logos/logo-xd.svg') }}"
                        ...
                        <td
                          ...
                          <div class="mt-2 avatar-group">
                            <a
                              ...
                              <img
                                src="{{ asset('theme/img/team-1.jpg') }}"
                            ...
                            <a
                              ...
                              data-placement="bottom">
                              <img
                                src="{{ asset('theme/img/team-3.jpg') }}"
                                class="w-full rounded-full"
                                alt="team3" />
                            </a>
                            <div
                            ...
                            <a
                              ...
                              data-placement="bottom">
                              <img
                                src="{{ asset('theme/img/team-4.jpg') }}"
                                class="w-full rounded-full"
                                alt="team4" />
                            </a>
                            <div
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('theme/img/small-logos/logo-atlassian.svg') }}"
                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                alt="atlassian" />
                            </div>
                            <div class="flex flex-col justify-center">
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('theme/img/small-logos/logo-slack.svg') }}"
                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                alt="team7" />
                            </div>
                            <div class="flex flex-col justify-center">
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('theme/img/small-logos/logo-jira.svg') }}"
                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                alt="jira" />
                            </div>
                            <div class="flex flex-col justify-center">
                      ...
                      <tr>
                        <td
                          ...
                          <div class="flex px-2 py-1">
                            <div>
                              <img
                                src="{{ asset('theme/img/small-logos/logo-invision.svg') }}"
                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                                alt="invision" />
                            </div>
                            <div class="flex flex-col justify-center">
